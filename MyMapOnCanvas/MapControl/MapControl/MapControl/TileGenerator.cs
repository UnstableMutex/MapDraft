...
namespace MapControl
{
    ...
    public static class TileGenerator
    {
        ...
        /// <summary>
        /// обрезает зум по минимуму и максимуму - чтобы не выходил за пределы
        /// </summary>
        /// <param name="value">текущий зум</param>
        /// <param name="minimum">мин</param>
        /// <param name="maximum">макс</param>
        /// <returns>допустимый зум</returns>
